...
import { yacht } from '../domain/fleet';
  ...
  return (
    <section id="yacht" className="relative py-20 lg:py-36 bg-card">
      <div className="container mx-auto px-5 lg:px-12">
          ...
          >
            ...
            <div className="relative aspect-[16/10] overflow-hidden mb-3 lg:mb-4">
              <AnimatePresence mode="wait">
                ...
                >
                  <ResponsiveImage
                    assetKey={currentGallery[activeImage]}
                    slot="card"
                    fallbackSrc={currentGallery[activeImage]}
              ...
              {currentGallery.map((img, i) => (
                ...
                >
                  <ResponsiveImage
                    ...
                    loading="lazy"
                    decoding="async"
                    sizes="(min-width: 1024px) 10vw, 80px"
                    className="w-full h-full object-cover"
                  />
                </button>
              ))}
        ...
        >
          <ResponsiveImage
            assetKey="/media/images/yachts/yacht-salon-dining-night.jpeg"
            slot="card"
            fallbackSrc="/media/images/yachts/yacht-salon-dining-night.jpeg"
