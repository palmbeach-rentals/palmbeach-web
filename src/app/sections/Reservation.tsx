...
import { vehicles, yacht } from '../domain/fleet';
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
            ...
            <div className="hidden lg:block relative overflow-hidden">
              <ResponsiveImage
                assetKey="/media/images/cars/maserati-mc20-front-symmetric-doors-open.jpg"
                slot="card"
                fallbackSrc="/media/images/cars/maserati-mc20-front-symmetric-doors-open.jpg"
